    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex flex-col items-center gap-3 mt-6">
          ...
          {/* Save the Date button - hidden when event has passed */}
          {!isPast && (
            <WavyBorderButton
              onClick={() =>
                handleSaveTheDate(groomName, brideName, date, startTime, endTime, venue, address)
              }
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true" role="presentation">

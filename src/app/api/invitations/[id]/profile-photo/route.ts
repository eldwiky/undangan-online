...
export async function POST(
  ...
  try {
    ...
    if (!type || !["groomPhoto", "bridePhoto", "ogImage", "heroPhoto"].includes(type)) {
      return NextResponse.json({ error: "Validation Error", message: "Type harus groomPhoto, bridePhoto, ogImage, atau heroPhoto", statusCode: 400 }, { status: 400 });
    }
